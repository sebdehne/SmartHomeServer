...
object FCS16 {
    ...
    fun calcFcs16(
        ...
        var fcs16 = 0xFFFF
        for (pos in offset until offset + length) {
            fcs16 = (fcs16 shr 8
                    xor fcstab[fcs16 xor buff[pos].toInt() and 0xFF]) and 0xFFFF
        }
        fcs16 = fcs16.inv()
        fcs16 = fcs16 shr 8 and 0xFF or (fcs16 shl 8)
        return fcs16 and 0xFFFF
    }
